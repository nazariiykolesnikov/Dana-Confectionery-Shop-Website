                ...
                <div className="shopping-cart__description">
                    ...
                    <p className="shopping-cart__category">
                        ...
                        {category.map((currentCategory) => (
                            <Link to={currentCategory.link} className="shopping-cart__category-link">{currentCategory.name}</Link>
                        ))}
                    </p>
                    ...
                    <p className="shopping-cart__time-to-prepare">Time to prepare<img className="shopping-cart__time-to-prepare-icon" src={assets.timer_logo} alt="recipe book logo" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<span>{timeToPrepare}</span></p>
